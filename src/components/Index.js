...
//             <Bounce><h1 className="font-weight-bolder">Jules <span className="text-primary">Clear</span></h1></Bounce>
//             <h4>Développeur Web,<br />
//               Étudiant à l'<a className="text-decoration-none" target="_blank" href="https://www.leschartreux.com/"><span style={{color: '#e83e8c'}}>Institution des Chartreux</span></a>.
//             </h4>
...
//   <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="267.9434" y1="320.4384" x2="122.4486" y2="8.4237">
//     <stop offset={0} style={{stopColor: '#e83e8c'}} />
//     <stop offset={1} style={{stopColor: '#007bff'}} />
//   </linearGradient>
//   <path className="st0" d="M34,96.2c6.1-20.2,15.5-51.4,43.3-66.7c11.9-6.5,23.2-7.9,108.3,8.7c75.8,14.9,103,23.1,132.9,42.1
...
//     <animate begin="0s" dur="20s" repeatCount="indefinite" attributeName="d" values="M34,96.2c6.1-20.2,15.5-51.4,43.3-66.7c11.9-6.5,23.2-7.9,108.3,8.7c75.8,14.9,103,23.1,132.9,42.1
// 	c16.5,10.5,24.8,15.7,30.4,24.2c32.9,49.1-15.6,143.4-72.5,195.8c-24.5,22.6-67.2,62-118.8,53.3c-44.5-7.5-69.8-46.4-90-77.5
// 	C53.2,253.8,9.2,178.2,34,96.2z;
...
<div className="pt-5 mt-3">
      <div className="container pt-md-5">
        <div className="row mt-5">
          <div className="col-md-6 col-12 d-block my-auto">
            <Bounce><h1 className="font-weight-bolder">Jules <span className="text-primary">Clear</span></h1></Bounce>
...
<div className="col-12 d-block mx-auto">
<h4 className="text-center bold text-secondary mt-md-5">"ACCESS_TOKEN"</h4>
</div>
